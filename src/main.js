    ...
    <main class="main-content">
      ...
      <section class="summary-grid">
        ...
        <article class="summary-card">
          ...
          <strong class="metric" id="reset-countdown">Calculating…</strong>
      ...
      <section class="dashboard-grid">
        ...
        <article class="panel reset-panel">
          ...
          <div class="reset-visual">
            ...
            <div>
              <strong id="reset-detail">Calculating next reset</strong>
              <p>
                Vendor recommendations will refresh after the weekly data is loaded.
              </p>
            </div>
          </div>
        </article>
        ...
        <article class="panel vendor-panel">
          <div class="panel-heading">
            ...
            <button class="primary-button">Open vendor tool</button>
          </div>
        ...
        <article class="panel activity-panel">
          ...
          <div class="empty-state">
            ...
            <p>
              Your purchases, donations, and Expertise changes will appear here.
            </p>
          </div>
        </article>
      </section>
...
function updateCountdown() {
  ...
  document.querySelector('#reset-detail').textContent =
